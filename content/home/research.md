...
<ul><li><h5> Covid and Productivity in Europe: A Responsiveness Perspective <i>(Draft available upon request)</h5>   <i>(with <a href=https://sites.google.com/site/coopereconomics/ target="_blank">Russell Cooper</a> and Wolfram Horn </i>)
