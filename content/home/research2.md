...
<ul>
<li><p><h5>{{<staticref "uploads/volatility_current.pdf" "newtab" >}} <i class="fas fa-file-alt"></i> Entrepreneurship Over The Life-Cycle: The Role of Human versus Financial Capital Accumulation {{< /staticref >}}</h5>
...
<ul><li><h5> Covid and Productivity in Europe: A Responsiveness Perspective <i>(Draft available upon request)</h5>(<i> with Russell Cooper and Wolfram Horn</i>)
...
<ul><li><p><h6> Anatomy of Entrepreneurial Skills</h6>
